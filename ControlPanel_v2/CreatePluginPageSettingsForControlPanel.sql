...
-- 2318398 -> Larry 
	...
	DECLARE		@Title					varchar(max)	=	'Plugins';
	DECLARE		@SeoURL					varchar(max)	=	'plugins';
	DECLARE		@Alias					varchar(max)	=	'Plugins';
	DECLARE		@Component				varchar(max)	=	'Configure';
	DECLARE		@Controller				varchar(max)	=	'RetrievePlugins';
	DECLARE		@MetaTitle				varchar(max)	=	'List Plugins';
	DECLARE		@MetaDescription		varchar(max)	=	'This is the Plugins page';
	DECLARE		@MetaKeywords			varchar(max)	=	'plugins, page';
	...
	DECLARE		@NavDescription			varchar(max)	=	'Manage your site''s plugins here.';
