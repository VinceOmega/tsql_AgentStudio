...
DECLARE	@Webpart				uniqueidentifier	=		'DC1F290C-993B-32FB-B33A-933B8B11E68B';
DECLARE @WPName					varchar(200)		=		'Control Panel : Search Engine Optimization - MetaData';
DECLARE	@WPDescription			varchar(500)		=		'Webpart that generates the metadata page for the search engine optimization section'
DECLARE @WPComponentName		varchar(100)		=		'ControlPanel.SearchEngineOptimization';
DECLARE @WPMethodName			varchar(100)		=		'RetrieveMetaData';
DECLARE @WPRightGuid			uniqueidentifier	=		'DC2385AF-0F9A-C4FE-77B6-BCBF1AB54E0B';
DECLARE	@WPParentGuid			uniqueidentifier	=		'D66AB29C-A1EB-AF57-F054-C0259179A364';
DECLARE	@WPRightName			varchar(200)		=		'Control Panel : Search Engine Optimization - MetaData';
DECLARE	@WPRightDescription		varchar(256)		=		'App has access to the Search Engine Optimization MetaData SubPage';
DECLARE	@WPCreateDate			datetime			=		GETDATE();
DECLARE	@WPLastModified			datetime			=		GETDATE();
DECLARE @WPRequiredRight		uniqueidentifier	=		'DC27AB79-ED03-7A86-25C7-D7D53305F3EB';
