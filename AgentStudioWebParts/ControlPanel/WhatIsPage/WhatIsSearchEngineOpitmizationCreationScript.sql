...
DECLARE	@Webpart				uniqueidentifier	=		'D74479FD-CFD0-3040-ED72-7A2687A41D6B';
DECLARE @WPName					varchar(200)		=		'What is: Search Engine Optimization';
DECLARE	@WPDescription			varchar(500)		=		'Webpart that generates the what is page for the search engine optimization section'
DECLARE @WPComponentName		varchar(100)		=		'ControlPanel.SearchEngineOptimization';
DECLARE @WPMethodName			varchar(100)		=		'RetrieveWhatIsSearchEngineOptimization';
DECLARE @WPRightGuid			uniqueidentifier	=		'D75DC6CA-935A-B75F-DEDB-EDD95E162EA4';
DECLARE	@WPParentGuid			uniqueidentifier	=		'00000000-0000-0000-0000-000000000000';
DECLARE	@WPRightName			varchar(200)		=		'What is Search Engine Optimization';
DECLARE	@WPRightDescription		varchar(256)		=		'App has access to the What Is Search Engine Optimization Page';
DECLARE	@WPCreateDate			datetime			=		GETDATE();
DECLARE	@WPLastModified			datetime			=		GETDATE();
DECLARE @WPRequiredRight		uniqueidentifier	=		'D75AAF16-F2FC-A6A9-E5BD-7551DCCA4CF8';
