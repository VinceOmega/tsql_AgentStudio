...
DECLARE	@Webpart				uniqueidentifier	=		'36262551-B87A-C8EE-5011-3BFB13E8AAAB';
DECLARE @WPName					varchar(200)		=		'What is: Site Customization';
DECLARE	@WPDescription			varchar(500)		=		'Webpart that generates the what is page for the site customization'
DECLARE @WPComponentName		varchar(100)		=		'ControlPanel.SiteSettings';
DECLARE @WPMethodName			varchar(100)		=		'RetrieveWhatIsSiteCustomization';
DECLARE @WPRightGuid			uniqueidentifier	=		'362AE09E-FBE2-8774-EC71-252BFEE05AA1';
DECLARE	@WPParentGuid			uniqueidentifier	=		'00000000-0000-0000-0000-000000000000';
DECLARE	@WPRightName			varchar(200)		=		'What is Site Customization';
DECLARE	@WPRightDescription		varchar(256)		=		'App has access to the What Is Site Customization Page';
DECLARE	@WPCreateDate			datetime			=		GETDATE();
DECLARE	@WPLastModified			datetime			=		GETDATE();
DECLARE @WPRequiredRight		uniqueidentifier	=		'363006D2-DACC-F8E6-7C77-54964CA78AD9';
